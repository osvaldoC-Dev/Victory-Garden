  ...
  head: () => ({
    meta: [
      ...
      { title: "Victory Garden Café — Greek & Mediterranean Dining in Astoria, NY" },
      {
        name: "description",
        content:
          "Greek & Mediterranean dining, desserts and cocktails in an indoor/outdoor garden on Steinway Street, Astoria, New York.",
      },
      { property: "og:site_name", content: "Victory Garden Café" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1e1c17" },
    ],
    links: [
